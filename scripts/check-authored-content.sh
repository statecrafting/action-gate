#!/usr/bin/env bash
# The organization's authored-content rules (U+2014, session links), made
# mechanical. Copied from statecrafting/statecraft-cli at
# 9bb61881ef3ec12b08f00f090bab45d8b3ee81e6; only this header and the two
# refusal messages differ.
#
...
# history under merge commits. No file is exempt in that mode.
#
